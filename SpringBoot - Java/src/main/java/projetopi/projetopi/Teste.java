...
public class Teste {
    ...
    public static void main(String[] args) {
        ...
        AgendaAux[] vetorAgendamento = new AgendaAux[5];
                ...
                // Criando um barbeiro
                Barbeiro barbeiro = new Barbeiro("João", "888888888", "joao@barbeiro.com");
        ...
        // Criando um barbeiro
        Barbeiro barbeiro2 = new Barbeiro("Pedro", "999999999", "pedro@barbeiro.com");
        ...
        // Criando barbeiros
        Barbeiro barbeiro3 = new Barbeiro("Pedro", "999999999", "pedro@barbeiro.com");
        Barbeiro barbeiro4 = new Barbeiro("Lucas", "777777777", "lucas@barbeiro.com");
        Barbeiro barbeiro5 = new Barbeiro("Marcos", "555555555", "marcos@barbeiro.com");
